function execute(url) {
    ...
    var oriname = doc.select("#oriname");
    var _detail = doc.select(".blk:has(.fa-info-circle) > div:nth-child(2)").html()
    _detail = _detail + '<br>'+doc.select(".blk:has(.fa-info-circle) > div:nth-child(4)").html()
    '<br>'
    doc.select(".blk:has(.fa-info-circle) > div:nth-child(3)").html();
